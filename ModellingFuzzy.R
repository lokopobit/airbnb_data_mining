...
# Include FUZZY RULES USING CHI'S METHOD
# Include FUZZY RULES USING GENETIC COOPERATIVE-COMPETITIVE LEARNING AND PITTSBURGH
# Include FUZZY RULES USING THE STRUCTURAL LEARNING ALGORITHM ON VAGUE ENVIRONMENT
# Include FUZZY RULES WITH WEIGHT FACTOR
# Include 
